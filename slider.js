            ...
            if (s) {
              var n = S(),
                ...
                k = u.map(function (t, i) {
                  ...
                  return (
                    (c += t[0] + t[1]), { abs: h, distance: o.rtl ? -1 * a + 1 - t[0] : a, portion: x, size: t[0] }
                  );
                });
              return (
                (f = L(f)),
  ...
  return function (n, i, e) {
    try {
      return (function (n, t) {
        ...
        t(
          [
            y(n, { drag: !0, mode: "snap", renderMode: "precision", rubberband: !0, selector: ".keen-slider__slide" }),
            x,
            b,
            g,
          ],
...
const initializeSliders = async () => {
  ...
  new KeenSlider(document.querySelector(`[flowappz-slider="true"]`), {
    loop: true,
    selector: document.querySelectorAll(`[flowappz-slider="true"] div`),
    // vertical: true,
  });
};
